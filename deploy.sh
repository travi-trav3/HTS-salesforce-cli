...
echo " 11. Add Completed_By__c and Completed_Date__c (and Customer_Site__c / Job_Code__c) to the"
echo "     Task page layout, and add Completed By + Completed Date to the Work Order (Project__c)"
echo "     Activity related list / activity view so a completed task shows the actual completer."
echo " 12. The Task list views 'HTS Pre-Mob Tasks' and 'HTS Pre-Mob Tasks - Due Next 7 Days'"
echo "     deploy with the object; share them with the relevant users if needed."
