...
echo ""
echo "  5. Build the Overdue Gate Task Alert as a scheduled flow (Salesforce does not allow"
...
echo ""
echo "  6. Wire up Chatter @mentions on PO Low Balance Alert in Flow Builder (Amanda + Nikki)."
echo ""
echo "  7. Run the Part 12 test plan from the brief."
